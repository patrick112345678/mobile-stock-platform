  ...
  return (
    <div className="min-h-screen bg-black text-white pb-safe">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-16">
        <div className="mb-10 flex flex-col gap-4 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
          <div className="text-xl font-bold sm:text-2xl">AI 股票分析平台</div>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
          <div>
            <div className="mb-3 text-sm text-zinc-400 sm:mb-4">AI Research / Stock / Crypto</div>
            <h1 className="mb-4 text-3xl font-bold leading-tight sm:mb-6 sm:text-4xl lg:text-5xl">
              用更直覺的方式
              <br />
              看股票、看市場、看 AI 分析
            </h1>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4 shadow-xl sm:p-6">
